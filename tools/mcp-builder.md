...
Choose your stack and follow language-specific guides:

- **Python**: Use FastMCP - see [python_mcp_server.md](reference/python_mcp_server.md)
- **TypeScript**: Use MCP SDK - see [node_mcp_server.md](reference/node_mcp_server.md)
...
Create evaluations per [evaluation.md](reference/evaluation.md):
...
See [mcp_best_practices.md](reference/mcp_best_practices.md) for complete guidelines.
