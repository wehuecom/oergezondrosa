...
description: Build n8n workflows using proven patterns. Use when creating, designing, or architecting any n8n workflow — webhooks, HTTP APIs, database operations, AI agents, scheduled automations, or data pipelines. This is the primary n8n skill for building workflows from scratch.
---
...
- **[build_patterns.md](build_patterns.md)** - Build preferences: loop outputs, Edit Fields vs Code, native nodes
