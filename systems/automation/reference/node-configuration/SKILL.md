...
description: Configure n8n nodes correctly — required fields, property dependencies, operation-specific settings. Use when setting up a specific node (Airtable, HTTP Request, Slack, etc.) and need to know what fields are required for each operation.
---
